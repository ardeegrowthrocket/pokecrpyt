<?php
 $field = array("rate_name");
 $where = getwheresearch($field);
 $total = countquery("SELECT rate_name FROM tbl_rate $where");
 //primary query
 $limit = getlimit(10,$_GET['p']);
$query = "SELECT * FROM tbl_rate $where $limit";
